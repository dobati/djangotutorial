...
from .functions import short_term 	## short term function to replace spelling_checker
...
def trans(request, message, dbtable, levelchoice):  
	...
	if form.is_valid():
		...
		try:
		    ...
		    previous_randomchoice = random_list[-1]
		saved_trans = userinputmodel.translation 	
		#spelling_checker(saved_trans)
		short_term(saved_trans)		## short term function to replace spelling_checker
