...
#### !!!!!!!!! Spanish not working, need to install Aspell Spanish dict on webfaction
...
#	
#	spelling = aspell.Speller('lang', 'en')
...
#### !!!!!!!!!!!!!!!!!!!!!!!!!!!!
# Function to return save_trans ---> short term solution!!!!!!!!!!!!!!!!!
# ========================================================================================

def short_term(inputsentence):
	global saved_tr
	saved_tr = inputsentence.encode('utf-8')
	return saved_tr
	
### !!!!!!!!!!!!!!!!!!!!!!!!
## Function compare_ref()	---> good compare_ref not working because of ES Aspell dict!!!!
## ========================================================================================
#
...
### !!!!!!!!!!!!!!!!!!!!!!!!
## Old compare_ref() function 	---> short term solution!!!!!!!!!!!
## ========================================================================================
